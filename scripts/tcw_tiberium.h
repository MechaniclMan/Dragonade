...
class tcw_tiberium_harvester : public ScriptImpClass 
{
...
class tcw_tiberium_field : public ScriptImpClass 
{
	void Created(GameObject *obj);
...
class tcw_tiberium_deposit : public ScriptImpClass 
{
	void Entered(GameObject *obj, GameObject *enterer);
};

class tcw_tiberium_spike : public ScriptImpClass
{
	void Created(GameObject *obj);
	void Custom(GameObject *obj, int message, int param, GameObject *sender);
...
class tcw_tiberium_spike_capture : public ScriptImpClass
{
	void Created(GameObject *obj);
	void Entered(GameObject *obj, GameObject *enterer);
	void Exited(GameObject *obj, GameObject *exiter);
...
class tcw_set_spike_team_created : public ScriptImpClass {
	void Created(GameObject *obj);
};
