...
1. Download and install the latest server version of scripts.dll from http://www.tiberiantechnologies.org/downloads. Note that version 1.0 of DA 
...
3. Configure da.ini and relevant gamemode.ini to your liking.
